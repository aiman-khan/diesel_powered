...
import 'package:diesel_powered/features/home/presentation/views/widgets/bottom_bar/bottom_bar_active_item.dart';
import 'package:diesel_powered/features/home/presentation/views/widgets/bottom_bar/bottom_bar_inactive_item.dart';
import 'package:diesel_powered/features/home/presentation/views/widgets/bottom_bar/bottom_bar_painter.dart';
...
class AnimatedNotchBottomBar extends StatefulWidget {
  ...
  @override
  State createState() => _AnimatedNotchBottomBarState();
}
        ...
        : AnimatedBuilder(
            ...
            builder: (BuildContext _, Widget? __) {
              ...
              return ClipRRect(
                child: Padding(
                  padding:
                      EdgeInsets.only(top: widget.removeMargins ? 22.h : 18.h),
                  child: Stack(
